...
To create a library that accesses the same instance of Browser, you have to import it via Robot Framework.

This import has to be done when the first keyword is called; otherwise you can run into issues with LibDoc.
