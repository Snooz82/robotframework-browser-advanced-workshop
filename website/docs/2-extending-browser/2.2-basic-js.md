...
**Exercises:**
Commands to try out in DevTools (F12) -> Console:
...
JS objects are similar to Python dictionaries and can be parsed and dumped as strings.

Literal syntax is a bit different: JS fields are typically written without quotes, whereas Python keys (if strings) are usually written with quotes.
...
Arrays in JavaScript have some nice functions to manipulate and process content.
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array

However, many iterables must be converted to an Array first.
...
- Open Dev Tools F12
- Paste this script into `Console` and execute
